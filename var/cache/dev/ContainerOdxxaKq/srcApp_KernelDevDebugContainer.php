...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/reviwer'), [0 => 'ROLE_ADMIN', 1 => 'ROLE_REVIEWER'], NULL);
