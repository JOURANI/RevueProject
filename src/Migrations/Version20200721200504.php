 ...
 */
final class Version20200721200504 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3A9F98E5A76ED395 ON institution');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E910405986 ON users (institution_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3A9F98E5A76ED395 ON institution (user_id)');
        $this->addSql('ALTER TABLE users DROP FOREIGN KEY FK_1483A5E910405986');
        $this->addSql('DROP INDEX UNIQ_1483A5E910405986 ON users');
